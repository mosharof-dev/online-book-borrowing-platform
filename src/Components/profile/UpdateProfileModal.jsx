...
import { Modal, ModalBackdrop, ModalContainer, ModalDialog, ModalHeader, ModalBody, ModalFooter, ModalHeading, Button, TextField, Label, Input, Avatar, Spinner } from "@heroui/react";
          ...
          <ModalDialog className="bg-[#1E293B] border border-white/10 rounded-[2rem] w-full max-w-md overflow-hidden shadow-2xl outline-none ring-0 animate-in zoom-in-95 duration-200">
                ...
                <TextField className="flex flex-col gap-1.5">
                  ...
                  <div className="relative flex items-center group">
                    ...
                    <Input
                      ...
                      className="w-full bg-[#0F172A] border border-white/10 text-white pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl focus:outline-none focus:border-[#FB8C00] focus:ring-1 focus:ring-[#FB8C00]/30 transition-all placeholder:text-slate-600 text-sm sm:text-base"
                    />
                  </div>
                </TextField>
            ...
            <ModalFooter className="p-5 sm:p-8 border-t border-white/5 flex flex-col sm:flex-row justify-end gap-3 bg-white/[0.02]">
              ...
              <Button 
                ...
                isDisabled={loading}
                className="order-1 sm:order-2 w-full sm:w-auto bg-[#FB8C00] text-white font-bold px-8 py-2.5 rounded-xl sm:rounded-2xl shadow-lg shadow-[#FB8C00]/20 hover:bg-[#E65100] active:scale-[0.98] transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
              >
