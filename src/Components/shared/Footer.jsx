        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-16">
          ...
          <div className="col-span-2 md:col-span-1 space-y-6">
            <Link href="/" className="flex items-center gap-2 group ">
              ...
              <span className="text-xl sm:text-2xl font-extrabold tracking-tight text-white inline-block align-middle ml-1 sm:ml-2">
            ...
            <div className="flex gap-3 pt-2">
              <Link href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-[#FB8C00] hover:text-white hover:border-[#FB8C00] hover:-translate-y-1 transition-all duration-300 shadow-lg">
                <FaFacebook size={14} /> 
              </Link>
              <Link href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-[#FB8C00] hover:text-white hover:border-[#FB8C00] hover:-translate-y-1 transition-all duration-300 shadow-lg">
                 <FaTwitter size={14} />
              ...
              <Link href="https://www.linkedin.com/in/mosharof-hosen/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-[#FB8C00] hover:text-white hover:border-[#FB8C00] hover:-translate-y-1 transition-all duration-300 shadow-lg">
                 <FaLinkedin size={14} />
              </Link>
            </div>
          </div>
          ...
          <div className="col-span-1 space-y-6">
            <h4 className="text-base sm:text-lg font-bold text-white mb-6 relative inline-block">
              Explore
          ...
          <div className="hidden sm:block col-span-1 space-y-6">
          ...
          <div className="col-span-1 space-y-6">
            ...
            <ul className="space-y-5 text-slate-400 text-sm">
              <li className="flex items-start gap-4 hover:text-white transition-colors group">
                <div className="mt-1 w-7 h-7 sm:w-8 sm:h-8 shrink-0 rounded-full bg-white/5 flex items-center justify-center text-[#FB8C00] group-hover:bg-[#FB8C00] group-hover:text-white transition-colors">
                  <FaMapMarkerAlt size={12} />
                </div>
                <div>
                  <p className="font-medium text-white mb-0.5 sm:mb-1">Location</p>
              ...
              <li className="flex items-start gap-4 hover:text-white transition-colors group">
                ...
                <div>
                  <p className="font-medium text-white mb-0.5 sm:mb-1">Call Us</p>
                  <p className="text-[10px] md:text-sm">+880 1799400971</p>
                </div>
              </li>
              <li className="flex items-start gap-4 hover:text-white transition-colors group">
                <div className="mt-1 w-7 h-7 sm:w-8 sm:h-8 shrink-0 rounded-full bg-white/5 flex items-center justify-center text-[#FB8C00] group-hover:bg-[#FB8C00] group-hover:text-white transition-colors">
                ...
                <div>
                  <p className="font-medium text-white mb-0.5 sm:mb-1">Email Us</p>
                  <p className="truncate max-w-[120px] sm:max-w-none text-[10px] md:text-sm">mosharof.dev@gmail.com</p>
                </div>
              </li>
            </ul>
          </div>
