...
const NotFound = () => {
  return (
    <div className="min-h-[80vh] w-full flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-130 bg-[#FB8C00]/10 blur-[120px] rounded-full pointer-events-none"></div>
      ...
      <div className="relative z-10 flex flex-col items-center max-w-2xl w-full">
        ...
        <div className="relative mb-8 animate-bounce duration-3000 ">
        ...
        <div className="bg-[#1E293B]/40 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[2.5rem] shadow-2xl text-center space-y-6 w-full max-w-lg border-b-[#FB8C00]/30 border-b-2">
          ...
          <p className="text-slate-400 text-sm md:text-base leading-relaxed">
            Oops! It seems the chapter you&apos;re looking for has been moved or
            doesn&apos;t exist in our library anymore.
          </p>
